 ...
 * 2.获取单个的方法，并调用
 *   public Constructor getConstructors(Class... parameterTypes) 获取单个的"公有的"构造方法
 *   public Constructor getDeclaredConstructor(Class...parameterTypes)获取"某个构造方法"可以是私有的  或受保护 公有 默认的
 *
 *   调用构造方法：
...
public class ConstructorCollector {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        ReflectTarget target = (ReflectTarget) con.newInstance("lala",1);
        //4获取单个私有的构造方法
